...
namespace InfraStructure.Persons
{
    public class PersonAccountRepository : IPersonAccountRepository
    {
        ...
        public PersonAccountRepository(UserManager<Person> userManager,
        ...
        public async Task<AuthModel> Registration(RegistrationModel model)
        {
            ...
            //mapping to user ==>using Extention Method
        ...
        private async Task<JwtSecurityToken> CreateJwtToken(Person user)
        {
